        ...
        <section id='tech' ref={ref}>
            <motion.div className='container' variants={opacityVariant} initial='initial' animate={animationControl}>
                <h2 className='title__h2' style={{ overflow: 'hidden' }}>
                    ...
                    <StaggeredText text='Tech' id='tech__heading' />
                </h2>
                <div className='tech__badges__grid'>
                    <div className='tech__badge'>
                        ...
                        <p className='spaced-text'>HTML5</p>
                    </div>
                    <div className='tech__badge'>
                        <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                            <title>CSS3</title>
                        ...
                        <p className='spaced-text'>CSS3</p>
                    </div>
                    <div className='tech__badge'>
                        <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                        ...
                        <p className='spaced-text'>JavaScript</p>
                    </div>
                    <div className='tech__badge'>
                        <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                            <title>React</title>
                        ...
                        <p className='spaced-text'>React</p>
                    </div>
                    <div className='tech__badge'>
                        <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                            <title>Redux</title>
                        ...
                        <p className='spaced-text'>Redux</p>
                    </div>
                    <div className='tech__badge'>
                        <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                            <title>Next.js</title>
                        ...
                        <p className='spaced-text'>Next.js</p>
                    </div>
                    <div className='tech__badge'>
                        <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                            <title>Gatsby</title>
                        ...
                        <p className='spaced-text'>Gatsby</p>
                    </div>
                    <div className='tech__badge'>
                        <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                            <title>Sass</title>
                        ...
                        <p className='spaced-text'>SASS</p>
                    </div>
                </div>
            </motion.div>
        </section>
